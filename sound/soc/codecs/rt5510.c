...
static const struct codec_reg_val e4_reg_inits[] = {
	...
	{ RT5510_REG_TDM_CFG3, 0x1c00, 0x0800 },
...
MODULE_LICENSE("GPL");
MODULE_VERSION("1.0.8_S");
/*
 * 1.0.7_S
 *	1. devm_richtek_spm_classdev_register failed,
 *	rt5510_codec_unregister_param_device should be called.
 * 1.0.8_S
 *	1. update 0x15[10] INIT SETTING = 0
 */
