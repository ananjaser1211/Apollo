...
#define IS_CC_WATER_POST(cc1, cc2)    \
    ((cc1 > S2MU106_WATER_THRESHOLD_POST_MV) && (cc2 > S2MU106_WATER_THRESHOLD_POST_MV))
#define IS_CC_DRY(cc1, cc2)    \
    ((cc1 > S2MU106_WATER_DRY_THRESHOLD_MV) && (cc2 > S2MU106_WATER_DRY_THRESHOLD_MV))
...
#define S2MU106_REG_BMC_RX_TF_TRIM  (0x1 << S2MU106_REG_BMC_RX_TF_TRIM) /* 0x01 */
#define S2MU106_REG_VBUS_WAKEUP_DIS  (0x1 << S2MU106_REG_VBUS_WAKEUP_DIS_SHIFT) /* 0x02 */
#define S2MU106_REG_COMP_HYS_TRIM  (0x3 << S2MU106_REG_VBUS_WAKEUP_DIS_SHIFT) /* 0x04 */
...
#define S2MU106_REG_PLUG_CTRL_OP_Mode_FORCE_EN \
		(0x1 << S2MU106_REG_PLUG_CTRL_OP_Mode_FORCE_EN_SHIFT)	/* 0x04 */
#define S2MU106_REG_PLUG_CTRL_VBUS_IND_FORCE_MODE \
		(0x1 << S2MU106_REG_PLUG_CTRL_VBUS_IND_FORCE_MODE_SHIFT) /* 0x08 */

#define S2MU106_REG_PLUG_CTRL_VBUS_IND_FORCE_EN \
		(0x1 << S2MU106_REG_PLUG_CTRL_VBUS_IND_FORCE_EN_SHIFT)	/* 0x10 */
#define S2MU106_REG_PLUG_CTRL_REG_UFP_ATTACH_OPT_EN \
		(0x1 << S2MU106_REG_PLUG_CTRL_REG_UFP_ATTACH_OPT_EN_SHIFT)	/* 0x20 */
...
#define S2MU106_REG_PLUG_CTRL_PD_RST_OPTION \
		(0x1 << S2MU106_REG_PLUG_CTRL_PD_RST_OPTION_SHIFT)	/* 0x80 */
