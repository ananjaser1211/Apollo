...
#if defined(CONFIG_MAX77705_FW_PID06_SUPPORT)
#include <linux/ccic/max77705_pass3_PID06.h>
...
static int of_max77705_dt(struct device *dev, struct max77705_platform_data *pdata)
{
	...
	pdata->extra_fw_enable = of_property_read_bool(np_max77705, "max77705,extra_fw_enable");
	if (pdata->extra_fw_enable)
		pr_info("%s: extra_fw_enable\n", __func__);
