...
#define RT_REGMAP_VERSION	"1.1.17_G"
/*
 * 1.1.17_G
 *	consider devm_kzalloc failed case, unregister API should be called.
 */
...
out_of_memory:
	i--;
	for (i ; i > 0; i--)
		debugfs_remove(rd->rt_reg_file[i]);
}
