...
/* S5K3M3SM_EVT0.1_Ver_0.1_MirrorFlip_20190806 */
...
/* 7_1008x756 120fps */
const u32 sensor_3m3_setfile_A_1008x756_120fps[] = {
	0xFCFC,	0x4000,	0x02,
	0x6214,	0x7971,	0x02,
	0x6218,	0x7150,	0x02,
	0x0136,	0x1A00,	0x02,
...
const struct sensor_pll_info_compact sensor_3m3_pllinfo_A_4032x2268_30fps = {
	...
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK */
	0x0C34, /* frame_length_lines */
	0x1408, /* line_length_pck */
};
...
const struct sensor_pll_info_compact sensor_3m3_pllinfo_A_1008x756_120fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK */
...
static const u32 *sensor_3m3_setfiles_A[] = {
	...
	sensor_3m3_setfile_A_1008x756_120fps,
...
static const u32 sensor_3m3_setfile_A_sizes[] = {
	...
	ARRAY_SIZE(sensor_3m3_setfile_A_1008x756_120fps),
...
static const struct sensor_pll_info_compact *sensor_3m3_pllinfos_A[] = {
	...
	&sensor_3m3_pllinfo_A_1008x756_120fps,
