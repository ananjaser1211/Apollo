...
#if 0
#define S5K3L6_PDAF_MAXWIDTH	128 /* MAX witdh size */
#define S5K3L6_PDAF_MAXHEIGHT	736 /* MAX height size */
#define S5K3L6_PDAF_ELEMENT	2 /* V4L2_PIX_FMT_SBGGR16 */
#endif

#define S5K3L6_MIPI_MAXWIDTH	0 /* MAX width size */
#define S5K3L6_MIPI_MAXHEIGHT	0 /* MAX height size */
#define S5K3L6_MIPI_ELEMENT	0 /* V4L2_PIX_FMT_SBGGR16 */

#define MAX_3L6_SETPIN_CNT 2

enum sensor_module_3l6_actuator {
	SENSOR_MODULE_3L6_WITHOUT_ACTUATOR = 0,
	SENSOR_MODULE_3L6_WITH_ACTUATOR = 1,
};
...
static struct fimc_is_sensor_cfg config_module_3l6[] = {
	...
	FIMC_IS_SENSOR_CFG(4128, 3096, 30, 0, 0, CSI_DATA_LANES_4, 1196, CSI_MODE_VC_ONLY, PD_NONE,
	...
	FIMC_IS_SENSOR_CFG(4128, 2324, 30, 0, 1, CSI_DATA_LANES_4, 1196, CSI_MODE_VC_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4128, 2324), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	FIMC_IS_SENSOR_CFG(2064, 1548, 30, 0, 2, CSI_DATA_LANES_4, 1196, CSI_MODE_VC_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2064, 1548), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	FIMC_IS_SENSOR_CFG(2064, 1160, 30, 0, 3, CSI_DATA_LANES_4, 1196, CSI_MODE_VC_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2064, 1160), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	FIMC_IS_SENSOR_CFG(1024, 768, 120, 0, 4, CSI_DATA_LANES_4, 1196, CSI_MODE_VC_ONLY, PD_NONE,
	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	/* UW CAMERA - POWER OFF */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "off_i2c", PIN_I2C, 0, 200);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "pin", PIN_FUNCTION, 0, 0);
	if (gpio_is_valid(gpio_subcam_sel)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_subcam_sel, "gpio_subcam_sel low", PIN_OUTPUT, 0, 0);
	}
...
static int sensor_module_3l6_power_setpin_with_af(struct device *dev,
	struct exynos_platform_fimc_is_module *pdata)
{
	struct fimc_is_core *core;
	struct device_node *dnode;
	...
	/* WIDE CAMERA - POWER ON */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst low", PIN_OUTPUT, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDD_CAM_IO_1P8", PIN_REGULATOR, 1, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDD_RCAM_A2P8", PIN_REGULATOR, 1, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDD_RCAM_CORE_1P05", PIN_REGULATOR, 1, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDD_RCAM_AF_2P8", PIN_REGULATOR, 1, 3000);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst high", PIN_OUTPUT, 1, 100);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "pin", PIN_FUNCTION, 2, 2000);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "on_i2c", PIN_I2C, 1, 0);

	/* WIDE CAMERA - POWER OFF */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "off_i2c", PIN_I2C, 0, 200);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_reset, "sen_rst low", PIN_OUTPUT, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDD_RCAM_AF_2P8", PIN_REGULATOR, 0, 1500);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDD_RCAM_CORE_1P05", PIN_REGULATOR, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDD_RCAM_A2P8", PIN_REGULATOR, 0, 0);
	...
	/* WIDE ROM POWER ON */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "VDD_RCAM_AF_2P8", PIN_REGULATOR, 1, 5000);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "VDD_CAM_IO_1P8", PIN_REGULATOR, 1, 1000);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "on_i2c", PIN_I2C, 1, 10);

	/* WIDE ROM POWER OFF */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "off_i2c", PIN_I2C, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "VDD_CAM_IO_1P8", PIN_REGULATOR, 0, 2000);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "VDD_RCAM_AF_2P8", PIN_REGULATOR, 0, 5000);
...
static int (* module_3l6_power_setpin[MAX_3L6_SETPIN_CNT])(struct device *pdev,
	struct exynos_platform_fimc_is_module *pdata) = {
	sensor_module_3l6_power_setpin,
	sensor_module_3l6_power_setpin_with_af
};
...
static int __init sensor_module_3l6_probe(struct platform_device *pdev)
{
	...
	use_af = of_property_read_bool(dev->of_node, "use_af");
	if(!use_af)
		exist_actuator = SENSOR_MODULE_3L6_WITHOUT_ACTUATOR;
	else
		exist_actuator = SENSOR_MODULE_3L6_WITH_ACTUATOR;
	...
	fimc_is_module_parse_dt(dev, module_3l6_power_setpin[exist_actuator]);
	...
	for (vc_idx = VC_BUF_DATA_TYPE_SENSOR_STAT; vc_idx < VC_BUF_DATA_TYPE_MAX; vc_idx++) {
		module->vc_max_size[vc_idx].stat_type = VC_STAT_INVALID;
		module->vc_max_size[vc_idx].sensor_mode = VC_SENSOR_MODE_INVALID;
		module->vc_max_size[vc_idx].width = 0;
		module->vc_max_size[vc_idx].height = 0;
		module->vc_max_size[vc_idx].element_size = 0;
		switch (vc_idx) {
		case VC_BUF_DATA_TYPE_SENSOR_STAT:
#ifdef USE_MS_PDAF
			if (use_pdaf)
			{
				module->vc_max_size[vc_idx].sensor_mode = VC_SENSOR_MODE_MSPD_GLOBAL_NORMAL;
				module->vc_max_size[vc_idx].stat_type = VC_STAT_MSPD_PD_PACKER;
			}
#endif
#if 0
			module->vc_max_size[vc_idx].width = S5K3L6_PDAF_MAXWIDTH;
			module->vc_max_size[vc_idx].height = S5K3L6_PDAF_MAXHEIGHT;
			module->vc_max_size[vc_idx].element_size = S5K3L6_PDAF_ELEMENT;
#endif
			break;
		case VC_BUF_DATA_TYPE_GENERAL_STAT:
			module->vc_max_size[vc_idx].width = S5K3L6_MIPI_MAXWIDTH;
			module->vc_max_size[vc_idx].height = S5K3L6_MIPI_MAXHEIGHT;
			module->vc_max_size[vc_idx].element_size = S5K3L6_MIPI_ELEMENT;
			break;
		}
	}
