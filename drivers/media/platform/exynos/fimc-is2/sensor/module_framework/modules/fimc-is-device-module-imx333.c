...
static struct fimc_is_sensor_cfg config_module_imx333[] = {
	...
	FIMC_IS_SENSOR_CFG(2016, 1136, 30, 0, 4, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_ONLY, PD_MOD3,
		...
		VC_IN(1, HW_FORMAT_RAW10, 2016, 284), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_USER, VC_MIPISTAT, 4032, 10),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
...
//	int gpio_camio_1p8_en = 0;
	...
	/* Normal on */
	SET_PIN_VOLTAGE(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDDA_2.8V_CAM", PIN_REGULATOR, 1, 0, 2800000);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDDA_1.8V_CAM", PIN_REGULATOR, 1, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDDD_1.05V_CAM", PIN_REGULATOR, 1, 0);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, "VDDVM_2.8V_OIS", PIN_REGULATOR, 1, 100);
	SET_PIN_SHARED(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, SRT_ACQUIRE,
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_reset, "sen_rst high", PIN_OUTPUT, 1, 9250);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "VDDD_1.05V_CAM", PIN_REGULATOR, 0, 0);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_OIS_FACTORY, GPIO_SCENARIO_ON, gpio_ois_ldo_en, "gpio_ois_ldo_en", PIN_OUTPUT, 1, 0); /*VDD_OIS_1P8*/
	...
	SET_PIN(pdata, SENSOR_SCENARIO_OIS_FACTORY, GPIO_SCENARIO_OFF, gpio_ois_ldo_en, "gpio_ois_ldo_en", PIN_OUTPUT, 0, 0); /*VDD_OIS_1P8*/
...
static int __init sensor_module_imx333_probe(struct platform_device *pdev)
{
	...
	module->cfgs = ARRAY_SIZE(config_module_imx333);
	module->cfg = config_module_imx333;
	module->ops = NULL;
