...
enum is_param {
	...
	PARAM_DCP_CONTROL,
	PARAM_DCP_CONFIG,
	PARAM_DCP_INPUT_MASTER,
	PARAM_DCP_INPUT_SLAVE,
	PARAM_DCP_OUTPUT_MASTER,
	PARAM_DCP_OUTPUT_SLAVE,
	PARAM_DCP_OUTPUT_MASTER_DS,
...
static inline enum dma_input_order change_to_input_order(enum dma_output_order output_order)
{
	...
	case DMA_OUTPUT_ORDER_CbCr:
		input_order = DMA_INPUT_ORDER_CbCr;
		break;
	case DMA_OUTPUT_ORDER_YYCbCr:
		input_order = DMA_INPUT_ORDER_YYCbCr;
		break;
	case DMA_OUTPUT_ORDER_CrYCbY:
		input_order = DMA_INPUT_ORDER_CrYCbY;
		break;
	case DMA_OUTPUT_ORDER_CbYCrY:
		input_order = DMA_INPUT_ORDER_CbYCrY;
		break;
	case DMA_OUTPUT_ORDER_YCrYCb:
		input_order = DMA_INPUT_ORDER_YCrYCb;
		break;
	case DMA_OUTPUT_ORDER_YCbYCr:
		input_order = DMA_INPUT_ORDER_YCbYCr;
		break;
