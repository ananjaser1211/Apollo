...
static char s6e3ha8_aod_self_move_pos_tbl[][90] = {
...
#ifdef CONFIG_SELF_MOVE_3PX
	{
		0x22, 0x33, 0x37, 0x03, 0x77,
		0x73, 0x37, 0x33, 0x07, 0x73,
		0x77, 0x33, 0x37, 0x03, 0x77,
		0x73, 0x37, 0x33, 0x07, 0x73,
		0x77, 0x33, 0x37, 0x03, 0x77,
		0x73, 0x37, 0x33, 0x07, 0x73,
		0x77, 0x33, 0x37, 0x03, 0x77,
	...
	{
		0xdd, 0x00, 0x33, 0x00, 0x37,
		0x00, 0x03, 0x00, 0x77, 0x00,
		0x73, 0x00, 0x37, 0x00, 0x33,
		0x00, 0x07, 0x00, 0x73, 0x00,
		0x77, 0x00, 0x33, 0x00, 0x37,
		0x00, 0x03, 0x00, 0x77, 0x00,
		0x73, 0x00, 0x37, 0x00, 0x33,
		0x00, 0x07, 0x00, 0x73, 0x00,
		0x77, 0x00, 0x33, 0x00, 0x37,
...
static char s6e3ha8_aod_self_move_patt_tbl[][76] = {
	{
		0x7D,
...
#ifdef SUPPORT_NORMAL_SELFMOVE
#if 0
	[SELFMOVE_TIMER_ON_MAPTBL] = DEFINE_0D_MAPTBL(s6e3ha8_self_timer_on,
		init_common_table, NULL, copy_selfmove_enable),
#endif
	[SELFMOVE_PATTERN_MAPTBL] = DEFINE_2D_MAPTBL(s6e3ha8_aod_self_move_patt_tbl,
		init_common_table, getidx_self_pattern, copy_selfmove_pattern),
#endif
};
...
char S6E3HA8_AOD_SELF_MOVE_POS[] = {
	...
	0x44, 0x44, 0x1C, 0xCC, 0xC3
#else
	0x33, 0x10, 0x10, 0x10, 0x10,
	0x01, 0x50, 0x50, 0x50, 0x50,
	0x05, 0x10, 0x10, 0x10, 0x10,
	0x01, 0x50, 0x50, 0x50, 0x50,
	0x05, 0x10, 0x10, 0x10, 0x10,
	0x01, 0x50, 0x50, 0x50, 0x50,
	0x05, 0x10, 0x10, 0x10, 0x10,
...
DEFINE_PKTUI(s6e3ha8_self_move_pattern, &s6e3ha8_aod_maptbl[SELFMOVE_PATTERN_MAPTBL], 0);
DEFINE_VARIABLE_PACKET(s6e3ha8_self_move_pattern, DSI_PKT_TYPE_WR, S6E3HA8_DEF_MOVE_PATTERN, 0);



static char S6E3HA8_SELF_TIMER_ON[] = {
	0x77,
#ifdef FAST_TIMER
...
#if 0
DEFINE_PKTUI(s6e3ha8_self_timer_on, &s6e3ha8_aod_maptbl[SELFMOVE_TIMER_ON_MAPTBL], 0);
DEFINE_VARIABLE_PACKET(s6e3ha8_self_timer_on, DSI_PKT_TYPE_WR, S6E3HA8_SELF_TIMER_ON, 0);
#else
DEFINE_STATIC_PACKET(s6e3ha8_self_timer_on, DSI_PKT_TYPE_WR, S6E3HA8_SELF_TIMER_ON, 0);
#endif

static char S6E3HA8_SELF_MOVE_SET[] = {
	0x7C,
	0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00
};

DEFINE_STATIC_PACKET(s6e3ha8_self_move_set, DSI_PKT_TYPE_WR, S6E3HA8_SELF_MOVE_SET, 0);

static void *s6e3ha8_enable_selfmove[] = {
	&KEYINFO(s6e3ha8_aod_level3_key_enable),
	&KEYINFO(s6e3ha8_aod_level2_key_enable),
	...
	&PKTINFO(s6e3ha8_self_timer_on),
	&PKTINFO(s6e3ha8_self_move_set),
	
	&PKTINFO(s6e3ha8_self_move_pattern),

	&KEYINFO(s6e3ha8_aod_level2_key_disable),
	&KEYINFO(s6e3ha8_aod_level3_key_disable),
};

static void *s6e3ha8_disable_selfmove[] = {
	&KEYINFO(s6e3ha8_aod_level2_key_enable),
	&PKTINFO(s6e3ha8_aod_self_move_sync_off),
	&PKTINFO(s6e3ha8_aod_normal_setting),
	&KEYINFO(s6e3ha8_aod_level2_key_disable),
